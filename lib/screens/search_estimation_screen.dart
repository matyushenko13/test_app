            ...
            child: Column(
                ...
                children: <Widget>[
                  ...
                  Padding(
                    ...
                    child: BlocConsumer<SearchEstimationBloc,
                        SearchEstimationState>(
                      builder: (context, state) {
                        ...
                        return MaterialButton(
                          ...
                          onPressed: () => context
                              .read<SearchEstimationBloc>()
                              .submit(index: _indexController.text),
                        );
                      },
                      listenWhen: (previous, current) =>
                          current is SuccessStateSearchEstimation ||
                                  current is ErrorStateSearchEstimation
                              ? true
                              : false,
                      listener: (context, state) {
                        ...
                        if (state is SuccessStateSearchEstimation) {
                          context
                              .read<HistoryEstimationBloc>()
                              .update(estimation: state.estimation);
